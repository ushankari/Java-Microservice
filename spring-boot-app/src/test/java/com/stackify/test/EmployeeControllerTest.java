...
public class EmployeeControllerTest {
    ...
    public void whenCreateGetEmployee_thenOk() throws Exception {
        ...
        //this.mockMvc.perform(get("/employees")).andExpect(status().isOk()).andExpect(content().contentType(CONTENT_TYPE)).andExpect(jsonPath("$", hasSize(2))).andExpect(jsonPath("$[0].name",is("saurabh")));
    }
}
